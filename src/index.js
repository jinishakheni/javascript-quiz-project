document.addEventListener("DOMContentLoaded", () => {
  ...
  function showQuestion() {
    ...
    progressBar.style.width = `${quiz.currentQuestionIndex * 100 / questions.length}%`;// This value is hardcoded as a placeholder
  ...
  function nextButtonHandler() {
    ...
    const allRadioButton = document.getElementsByName("choice");
    ...
    allRadioButton.forEach(currentRadio => {
      if (currentRadio.checked)
        selectedAnswer = currentRadio.value;
    });
